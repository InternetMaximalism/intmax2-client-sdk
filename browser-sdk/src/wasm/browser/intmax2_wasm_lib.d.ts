...
export interface InitOutput {
  ...
  readonly __wbg_get_jsentrystatuswithblocknumber_status: (a: number) => number;
  readonly __wbg_set_jsentrystatuswithblocknumber_status: (a: number, b: number) => void;
  ...
  readonly __wbg_get_jsdepositentry_deposit: (a: number) => number;
  readonly __wbg_set_jsdepositentry_deposit: (a: number, b: number) => void;
  ...
  readonly __wbg_jsreceiveentry_free: (a: number, b: number) => void;
  readonly __wbg_get_jsreceiveentry_transfer: (a: number) => number;
  readonly __wbg_set_jsreceiveentry_transfer: (a: number, b: number) => void;
  readonly __wbg_get_jsreceiveentry_status: (a: number) => number;
  readonly __wbg_set_jsreceiveentry_status: (a: number, b: number) => void;
  readonly __wbg_get_jsreceiveentry_meta: (a: number) => number;
  readonly __wbg_set_jsreceiveentry_meta: (a: number, b: number) => void;
  readonly __wbg_jssendentry_free: (a: number, b: number) => void;
  readonly __wbg_get_jssendentry_tx: (a: number) => number;
  readonly __wbg_set_jssendentry_tx: (a: number, b: number) => void;
  readonly __wbg_get_jssendentry_status: (a: number) => number;
  readonly __wbg_set_jssendentry_status: (a: number, b: number) => void;
  readonly __wbg_get_jssendentry_meta: (a: number) => number;
  readonly __wbg_set_jssendentry_meta: (a: number, b: number) => void;
  readonly __wbg_jshistoryentry_free: (a: number, b: number) => void;
  readonly __wbg_get_jshistoryentry_deposit: (a: number) => number;
  readonly __wbg_set_jshistoryentry_deposit: (a: number, b: number) => void;
  readonly __wbg_get_jshistoryentry_receive: (a: number) => number;
  readonly __wbg_set_jshistoryentry_receive: (a: number, b: number) => void;
  readonly __wbg_get_jshistoryentry_send: (a: number) => number;
  readonly __wbg_set_jshistoryentry_send: (a: number, b: number) => void;
  ...
  readonly fetch_history: (a: number, b: number, c: number) => any;
  ...
  readonly closure1355_externref_shim: (a: number, b: number, c: any, d: any) => void;
