...
class TokenFetcher {
    constructor(environment) {
        ...
        __classPrivateFieldSet(this, _TokenFetcher_httpClient, (0, utils_1.axiosClientInit)({
            baseURL: environment === 'mainnet'
                ? constants_1.MAINNET_ENV.tokens_url
                : environment === 'testnet'
                    ? constants_1.TESTNET_ENV.tokens_url
                    : constants_1.DEVNET_ENV.tokens_url,
        }), "f");
        __classPrivateFieldSet(this, _TokenFetcher_publicClient, (0, viem_1.createPublicClient)({
    ...
    async getTokensById(tokenIds) {
        const contracts = tokenIds.map((id) => ({
            abi: constants_1.liquidityAbiNft,
